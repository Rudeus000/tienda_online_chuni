...
// Si necesitamos $db o $con, ya están definidos globalmente

$errors = [];

// Verificar si hay un error de sesión expirada
if (isset($_GET['error']) && $_GET['error'] == 'sesion_expirada') {
    $errors[] = "Tu sesión ha expirado. Por favor, inicia sesión nuevamente.";
}

if (!empty($_POST) && isset($_POST['usuario']) && isset($_POST['password'])) {
    ...
    if (empty($errors)) {
        ...
        // login() retorna un mensaje de error o hace redirect si es exitoso
...
<head>
    ...
    <meta name="author" content="KEYBEN BUITRON" />
    <title>Inicio de sesión - The mystical Star</title>
                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-2">The mystical Star</h3>
                                </div>
                                <div class="card-body">
                ...
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">
                            <?php echo date('Y'); ?> &copy; <a href=" https://keybenbuitron.com/">The mystical Star</a>
                        </div>
                    </div>
                </div>
            </footer>
